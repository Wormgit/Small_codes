...
parser.add_argument('--set_dir', default='/home/io18230/Desktop/RGBDCows2020_val/Identification/RGB', type=str)
...
for im in sorted(os.listdir(args.set_dir)):
    ...
    n = len(list_of_file)
    other, train = data_split(list_of_file, ratio=1, shuffle=True)
